 ...
 */
public class HomeOnlineAdapter extends BaseQuickAdapter<HomeEntity.InfoBean.OnlineListBean, BaseViewHolder> {
    private List<HomeEntity.InfoBean.OnlineListBean> list;

    public HomeOnlineAdapter(int layoutResId, List data) {
