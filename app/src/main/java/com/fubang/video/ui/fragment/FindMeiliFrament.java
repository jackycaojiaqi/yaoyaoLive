 ...
 */
public class FindMeiliFrament extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_find_meili, container, false);
    ...
    private void initdate() {
        url = AppConstant.BASE_URL + AppConstant.URL_NVSHENG_YUE;
    ...
    private void setTopOneView(int position) {
        ...
        tvRankOneAge.setText(list_circle.get(position).getNage() != null ? list_circle.get(position).getNage() : getString(R.string.null_string));
        tvRankOneCity.setText(list_circle.get(position).getCcity() != null ? list_circle.get(position).getCcity() : getString(R.string.null_string));
    ...
    private void setTopTwoView(int position) {
        ...
        tvRankTwoAge.setText(list_circle.get(position).getNage() != null ? list_circle.get(position).getNage() :getString(R.string.null_string));
        tvRankTwoCity.setText(list_circle.get(position).getCcity() != null ? list_circle.get(position).getCcity() :getString(R.string.null_string));
        if (list_circle.get(position).getNgender().equals("0")) {
    ...
    private void setTopThreeView(int position) {
        ...
        tvRankThreeAge.setText(list_circle.get(position).getNage() != null ? list_circle.get(position).getNage() :getString(R.string.null_string));
        tvRankThreeCity.setText(list_circle.get(position).getCcity() != null ? list_circle.get(position).getCcity() : getString(R.string.null_string));
        if (list_circle.get(position).getNgender().equals("0")) {
